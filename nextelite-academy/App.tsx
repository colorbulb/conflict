...
import { getAppData } from './firebase/db.js';
...
const AppContent: React.FC<AppContentProps> = ({ translations, onUpdateTranslations }) => {
        ...
        if (enData && zhData) {
          setDb({
            en: {
              ...
              themeColors: enData.themeColors || INITIAL_DATA.en.themeColors,
              trialSettings: enData.trialSettings || INITIAL_DATA.en.trialSettings,
            ...
            zh: {
              ...
              themeColors: zhData.themeColors || INITIAL_DATA.zh.themeColors,
              trialSettings: zhData.trialSettings || INITIAL_DATA.zh.trialSettings,
  ...
  const InstructorsPage = () => (
    <div className="min-h-screen pt-24 pb-20 bg-brand-yellow/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-display font-bold text-gray-900 mb-4">{t.headings.mentors}</h2>
          <p className="text-gray-600 text-lg">{t.headings.mentorsSub}</p>
  ...
  const ContactPage = () => (
    <div className="min-h-screen pt-24 pb-20 bg-gradient-to-br from-brand-yellow/20 to-brand-orange/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row">
          <div className="p-10 md:w-5/12 bg-brand-blue text-white flex flex-col justify-between relative overflow-hidden">
            <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10"></div>
...
const App: React.FC = () => {
  ...
  return (
    <LanguageProvider translations={translations}>
      <AppContent translations={translations} onUpdateTranslations={setTranslations} />
    </LanguageProvider>
  );
};
