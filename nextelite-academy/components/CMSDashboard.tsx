                         ...
                         <div>
                             <div className="flex justify-between items-center mb-2">
                                 ...
                                 <div className="flex gap-2">
                                     <button
                                         onClick={() => {
                                             const useLayout = !editingPage.layoutBlocks;
                                             setEditingPage({
                                                 ...editingPage,
                                                 layoutBlocks: useLayout ? [] : undefined,
                                                 content: useLayout ? '' : (editingPage.content || '')
                                             });
                                         }}
                                         className={`text-xs px-3 py-1 rounded-lg font-bold transition-colors ${
                                             editingPage.layoutBlocks !== undefined
                                                 ? 'bg-brand-purple text-white' 
                                                 : 'bg-gray-200 text-gray-700 hover:bg-gray-300'
                                         }`}
                                     >
                                         {editingPage.layoutBlocks !== undefined ? 'Using Layout Builder' : 'Switch to Layout Builder'}
                                     </button>
                                 </div>
                             </div>
                             ...
                             {editingPage.layoutBlocks !== undefined ? (
                                 <LayoutBuilder
                                     blocks={editingPage.layoutBlocks || []}
                                     onChange={(blocks) => {
